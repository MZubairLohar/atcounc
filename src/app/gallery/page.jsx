...
<h1 className="text-black text-center text-5xl font-bold">OUR GALLERY</h1>
<h1 className="text-black text-center text-2xl">See some of our photos from past years' events!</h1>
</div>
<div className="flex justify-center gap-10 mt-10">
  <div className="flex flex-col items-center">
    <img 
      ...
      alt="Image 1"
    />
    <p className="text-md text-black mt-2">A view of last year's booths at the Symposium</p>
  </div>
  ...
  <div className="flex flex-col items-center">
    <img 
      ...
      alt="Image 2"
    />
    <p className="text-md text-black mt-2">Breakaway session at last year's Symposium</p>
  </div>
</div>
...
<div className="flex justify-center mt-10">
  ...
  <div className="flex flex-col items-center">
    <img 
      ...
      alt="Image 1"
    />
    <p className="text-md text-black mt-2">ATS Unit Scholarship Fund Presentation</p>
  </div>
  ...
  <div className="flex flex-col items-center">
    <img 
      ...
      alt="Image 2"
    />
    <p className="text-md text-black mt-2">The New Jersey State Police Pipe Band</p>
  </div>
</div>
