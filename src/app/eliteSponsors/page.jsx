...
<div className="mt-14 space-x-20 space-y-10">
    <h1 className="text-black text-center text-6xl font-bold">ELITE SPONSORS</h1>
  ...
  <div className="w-2/3 text-md flex flex-col text-left justify-center"> 
    ...
    <h1>
      ...
      <a href="https://1110gear.com/" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">
        www.1110gear.com
      </a>
    </h1>
  </div>
    ...
    <div className="flex justify-between text-black">
        ...
        <div className="w-2/3 text-md flex flex-col text-left justify-center">
            ...
            <h1>For two decades Benchmade has been designing and manufacturing the world's finest knives and edged tools. Our products are developed and tested for extreme duty and are the preferred cutting tools for Elite Military Troops and Public Safety Professionals around the globe. You can count on your Benchmade to get the job done. USA Proud!<a href="https://www.benchmade.com/" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">
  www.benchmade.com
</a>
</h1>
        </div>
    ...
    <div className="flex justify-between text-black">
        ...
        <div className="w-2/3 text-md flex flex-col text-left justify-center">
            ...
            <h1>Founded in 2014, Circle Squared Alternative Investments LLC (CSQ) is a privately held Real Estate Investment firm. Founder Jeff Sica’s vision and belief is that sophisticated investors want and deserve access to alternatives to the public markets. Working with accomplished real estate developers with track records and deep experience while creating strong investment partnerships, CSQ has connected family offices and high net worth individuals with real estate projects that have traditionally only been available to institutional investors. CSQ is dedicated to helping you bridge the gap between your investment goals and your ability to achieve them.<a href="https://www.circlesquaredalts.com" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">www.circlesquaredalts.com</a></h1>
        </div>
    </div>
    <div className="flex justify-center">
    <hr className="border-black w-11/12" />
    ...
    <div className="flex justify-between text-black">
        ...
        <div className="w-2/3 text-md flex flex-col text-left justify-center">
            ...
            <h1>As your advocate and fiduciary, we will custom-build a financial plan for you – one that is designed to help you protect, grow, and transition your wealth.<a href="https://www.shorehavenwealth.com/" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">shorehavenwealth.com</a></h1>
        </div>
    </div>
</div>
